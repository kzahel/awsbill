...
def get_report(service, date_from, date_to, username, password, format='csv', period='days', usagetype=None, debug=False):
...
if __name__ == "__main__":
    ...
    USAGE = (
        ...
        "Available usage types: " + ', '.join(USAGETYPES)
    )
    ...
    parser.add_option('-t', '--usagetype', dest='usagetype', metavar='USAGETYPE', default=None)
